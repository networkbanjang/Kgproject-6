...
<link rel="stylesheet" href="/KG-naver/member/RegistForm.css">
...
<form id="join_form" method="post" action="registService.jsp">
    <input type="hidden" id="token_sjoin" name="token_sjoin" value="APdEbM6mpT6xz7m3">
            ...
            <div class="join_content">
                ...
                <div class="row_group">
                    <div class="join_row">
                        ...
                        <span class="error_next_box" id="idMsg" style="display:none" aria-live="assertive">필수 정보입니다.</span>
                    </div>
...
<form name="form_ipin" method="post" action="">
    ...
    <input type="hidden" name="enc_data" value="">
</form>

<script type="text/javascript" src="/KG-naver/js/rsaAll.js"></script>
<script type="text/javascript" src="/KG-naver/js/lua.js"></script>
<script type="text/javascript" src="/KG-naver/js/jquery.js"></script>
<script type="text/javascript" src="/KG-naver/js/bvsd.js"></script>
...
//    }
    ...
    function createRsaKey() {
        var rsa = new RSAKey();
        var sessionKey = "dkQdaUNio3uGrBy2";
        var keyName = "100017676";
        var eValue = "";
        var nValue = "010001";

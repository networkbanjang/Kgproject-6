...
<%	
	...
	if(userId == null || userId == ""){
		out.print("<script>alert('아이디를 입력해주세요.'); history.back(); </script>");
		return;
	}
	if(tel == null || tel == ""){
		out.print("<script>alert('전화번호를 입력해주세요.'); history.back(); </script>");
		return;
	}
...
%>
<script>alert('입력하신 아이디를 찾을 수 없습니다.'); history.back(); </script>
...
%>		
	<script>alert('입력하신 전화번호가 일치하지 않습니다.'); history.back(); </script>
<% 
		return;
	}
%>
...
<link rel="stylesheet" type="text/css" href="/KG-naver/css/find_sign.css">
<link href="https://nid.naver.com/favicon_1024.png" rel="apple-touch-icon-precomposed" sizes="1024x1024"> 
<link rel="stylesheet" type="text/css" href="/KG-naver/css/find_help.css">
<link rel="stylesheet" type="text/css" href="/KG-naver/css/find_HF.css">
<script type="text/javascript" src="/inc/user/js/idPwInquiryAjax.js?20140106"></script>
<script type="text/javascript" src="/KG-naver/member/js/clickcr.js"></script>
...
<script type="text/javascript" src="/KG-naver/member/js/nclk.js"></script>
<script type="text/javascript" src="https://nid.naver.com/inc/user/js/browser.js?20220411"></script>
<script type="text/javascript" src="/KG-naver/member/js/lua.js"></script>
...
function createRsaKey() {
	var rsa = new RSAKey();
	var sessionKey = "ydRaazeSP3FTH5s2";
	var keyName = "100017671";
	var eValue = "";
	var nValue = "010001";
	var id = "dun05066";
	...
	<div id="header" class="header_type2">
		...
		<div id="lnb" class="lnb_wrap">
			<ul class="lnb lnb_type3">
				<li class="m5"><a href="#" id="idinquiry" onmouseover="showMenu('idinquiry','pwinquiry');" onmouseout="hideMenu('pwinquiry');" class=""><span class="blind">아이디 찾기</span></a></li>
				<li class="m6"><a href="/KG-naver/member/findPw.jsp" id="pwinquiry" onmouseover="showMenu('pwinquiry','idinquiry');" onmouseout="hideMenu('pwinquiry');" class="on"><span class="blind">비밀번호 재설정</span></a></li>
			</ul>
...
<!-- CONTENTS -->
		<div id="content" class="non_sign inquiry" onclick="clearDocs();">
			...
			<form id="fm" name="f" action="/KG-naver/member/findPwService.jsp" method="post">
            <input type="hidden" id="encNewPasswd" name="encNewPasswd" value="">
            <input type="hidden" id="encNm" name="encNm" value="">
			<input type="hidden" id="id" name="id" value="dun05066">
			<input type="hidden" id="token_help" name="token_help" value="GffobKttFTgGzmI2">
			<input type="hidden" id="captcha_type" name="captcha_type" value="image">
			<input type="hidden" id="chptchakey" name="chptchakey" value="A6sxsmcabWLyOSjI">
			...
			<div class="section section_find">
				<div class="box6">
					...
					<div id="div_new_pw" class="input_box">	
						...
						<input id="new_pw" name="new_pw" type="password" value="" maxlength="20" onkeyup="checkShiftUp(event);checkpwd_nologin('new_pw','id');" onkeypress="capslock(event);" onkeydown="checkShiftDown(event);" onfocus="checkpwd_nologin('new_pw','id');convertDiv('new_pw', 'new_conf_pw', 'none');" onblur="showhelpmsg(-1);convertDiv('new_pw', 'new_conf_pw','block')" title="새 비밀번호 입력" class="input_txt">
<!-- ///////////////////////////////////////////////////////////////////////////////////////// -->	
				...
				<div class="find_dsc">
					<p>비밀번호를 바꾸면, 모바일 기기(휴대전화/태블릿 PC)와 외부 메일 프로그램(POP3)에서 모두 로그아웃 됩니다.<br>새로운 비밀번호로 다시 로그인해 주세요.</p>
				</div>
				<p></p>
			</div></form>
		</div>

					...
					<div class="gnb_common_area">
						...
						<ul class="gnb_lst" id="gnb_lst" style="display: block;">
							<li class="gnb_login_li" id="gnb_login_layer" style="display: inline-block;">
								<a class="gnb_btn_login" href="#" id="gnb_login_button">
							...
							<li class="gnb_reg_li" id="gnb_reg_layer" style="display: inline-block;">
								<a class="gnb_btn_reg" href="#" id="gnb_reg_button">
		...
		<div class="nav_inner">
			...
			<ul class="nav_list" id="au_lnb" role="menubar">
				<li class="menu on" role="presentation">
					<a href="main.jsp" role="menuitem" class="item" id="au_lnb_home" tabindex="0" onclick="nhn.Kin.Utility.nClicks('LNB.home', '', '', event);" aria-current="page"><em>홈</em></a>
				</li>
				...
				<li class="menu" role="presentation">
					<a href="hall.jsp" role="menuitem" class="item" tabindex="-1" onclick="nhn.Kin.Utility.nClicks('LNB.honor', '', '', event);"><em>명예의전당</em></a>
				</li>
				<li class="menu" role="presentation">
					<span class="lnb_bar">|</span>
					<a href="myinfo.jsp" role="menuitem" class="item" tabindex="-1" onclick="nhn.Kin.Utility.nClicks('LNB.profile', '', '', event);"><em>프로필</em></a>
				</li>
				<li class="menu" role="presentation">
